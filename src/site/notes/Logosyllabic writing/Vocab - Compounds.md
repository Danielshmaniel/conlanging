---
{"dg-publish":true,"permalink":"/logosyllabic-writing/vocab-compounds/"}
---
...
| ------------------------------ | ----------- | ------------------------- | ------------------------ |
|                                | mezho       | senior (synonym of "zho") | person + old             |
...
|                          | kole         | cloth                                                               | unified + thread            |
|                          | koleme       | clothes                                                             | cloth + person              |
|                          | ten'te       | tool                                                                | use + hand                  |
|                          | ten'va       | hoe                                                                 | tool + plant                |
|                          | ten'vo       | axe                                                                 | tool + tree                 |
|                          | ten'qi       | spear                                                               | stick + pointy              |
...
|                          | qiksometan   | wheel                                                               | circle + moving             |
...
| glyph | sound           | meaning                          | combo                     |
| ----- | --------------- | -------------------------------- | ------------------------- |
|       | hema            | feeling                          | air (metaphorical) + body |
|       | gokomi          | sight / figure                   | thing + eye               |
|       | nen'gokomi      | likeness / resemblance           | same + sight              |
|       | yami            | colour                           | light + seeing            |
|       | hefe            | smell                            | air + nose                |
|       | hefi            | sound                            | air + ear                 |
|       | gavahan'tsa     | taste                            | food + (redup. of mouth)  |
|       | gavahan'tsa-van | fruity taste / sweet             | taste + fruit             |
...
| glyph                   | sound          | meaning                                          | combo                                  |
| ----------------------- | -------------- | ------------------------------------------------ | -------------------------------------- |
|                         | jano-(en)      | thought / to think                               | talk + head + (vrb)                    |
|                         | gokomino-(en)  | imagination / to imagine                         | figure + head + (vrb)                  |
...
|                         | thatsehya      | goal / aim / intention / motive                  | outcome + desired                      |
|                         | homi           | one's views / perspective / opinion / beliefs    | way/side + seeing                      |
|                         | hominen-(en)   | agreement / like-mindedness / believing in smth. | opinion + same + (vrb)                 |
|                         | homiki-(en)    | disagreement / conflict                          | opinion + division + (vrb)             |
...
|                            | ksun'qa-thime()                | to kill                                                                                                                 | death + (causative)                            |       |
...
|                            | \[()thaho]-metan-in'gogun-(en) | to return (to ...) / to come back (to ...) (in/transitive)                                                              | motion + near + (vrb)                          |       |
|                            | metan'fin-(en)                 | to pull oneself away (intransitive) / withdrawal                                                                        | motion + bow + (vrb)                           | 引     |
|                            | metan'fin-thime()              | to pull something towards oneself (transitive)                                                                          | motion + bow + (any p. causative)              | 引     |
|                            | metan'fin-thime                | pulling                                                                                                                 | motion + bow + (general causative)             |       |
|                            | metan'ten'qifin-(en)           | to be shot / to be projected forwards (intransitive)                                                                    | motion + arrow + (vrb)                         |       |
...
|                            | ksi-en                         | to cut                                                                                                                  | blade + (vrb)                                  |       |
|                            | ki-en                          | to break / to separate (intransitive)                                                                                   | part + (vrb)                                   |       |
|                            | ki-thime()                     | to break / separate (transitive)                                                                                        | part + (causative)                             |       |
|                            | metan'wi-en                    | to rise up                                                                                                              | motion + up + (vrb)                            |       |
|                            | metan'wi-thime()               | to raise something up                                                                                                   | motion + up + (vrb)                            |       |
|                            | metan'wo-en                    | to go down                                                                                                              | motion + down + (vrb)                          |       |
|                            | metan'wo-thime()               | to lower something                                                                                                      | motion + down + (causative)                    |       |
|                            | metan'teri-(en)                | to fly / to flap one's wings                                                                                            | motion + wing + (vrb)                          |       |
|                            | metetan-thime()                | to control                                                                                                              | person + do + (causative)                      |       |
|                            | hefiri-(en)                    | to sing / song                                                                                                          | sound + bird + (vrb)                           |       |
|                            | mi-en                          | to see / watch                                                                                                          | eye + (vrb)                                    |       |
|                            | mi-thime()                     | to show (the subj something)                                                                                            | eye + (causative)                              |       |
|                            | wini-(en)                      | to increase (intransitive)                                                                                              | up + number + (vrb)                            |       |
|                            | wini-thime()                   | to increase (transitive)                                                                                                | up + number + (causative)                      |       |
|                            | woni-(en)                      | to decrease / to dwindle (intransitive)                                                                                 | down + number + (vrb)                          |       |
|                            | woni-thime()                   | to decrease / to reduce (transitive)                                                                                    | down + number + (causative)                    |       |
|                            | magokofin-en                   | to bend (intransitive)                                                                                                  | shape + bow + (vrb)                            |       |
|                            | magokofin-thime()              | to bend something (transitive)                                                                                          | shape + bow + (causative)                      |       |
|                            | shuma-(en)                     | to fall asleep / to put one's own body to sleep (as opposed to idling or resting awake)                                 | rest + body                                    |       |
|                            | shumetan-(en)                  | to stop or refrain from (moving or doing smth.) / to stay still / to idle                                               | rest + motion                                  |       |
|                            | leko-en                        | to connect / to relate / to tie smth. with smth. (ditransitive)                                                         |                                                |       |
|                            | leko-en'goko                   | connecting / relating                                                                                                   |                                                |       |
|                            | ten'to-(en)                    | to work (intransitive), to put effort into smth. (transitive), to use one's energy on smth. (transitive) / work, effort | use + ability                                  |       |
### Roles
...
|                         | hin-an      | only, alone, single, individual (adj)               | one + (adj)                  |
|                         | ko-an       | unified, together, complete                         | complete + (adj)             |
|                         | ki-an       | broken, split apart, fragmented, divided            | part + (adj)                 |
|                         | ko-en       | to gather (in/transitive), to unify                 |                              |
|                         | ki-en       | to break (in/transitive), to split apart, to divide |                              |
|                         | otse        | addition / inclusion / putting together / joining   | and + (<-semantic)           |
...
|                          | widen     | upright / standing / perpendicular  | up + straight   |
|                          | ksun'qi   | point, dot, pinprick, (fullstop)    | end + pointy    |
### Spatial concepts
...
| glyph | sound            | meaning                           | combo                      |
| ----- | ---------------- | --------------------------------- | -------------------------- |
|       | in'yuntsu        | during                            | within + time              |
|       | in'thiyuntsu     | before                            | within + (cause) + time    |
|       | in'thayuntsu     | after                             | within + (result) + time   |
...
|       | yuntsumebon'zhin | teenhood, teen age                |                            |
|       | yuntsumebon      | adulthood                         | time + adult               |
|       | yuntsuzho        | elderhood, old age                | time + elder               |
|       | nizhozhin        | age                               | measurement + aging        |
### Question/Indefinite Words

| glyph | sound        | meaning                                 | combo            |
| ----- | ------------ | --------------------------------------- | ---------------- |
|       | meshi        | who / someone                           | person + what    |
|       | thatsehyashi | why / for what reason / for some reason | intention + what |
|       | hoshi        | how / in what way / somehow             | way + what       |
|       | gogun'shi    | where / somewhere                       | land + what      |
|       | yuntsushi    | when / sometime                         | time + what      |
|       | nishi        | how many / how much / some (amount)     | number + what    |
|       | etseshi      | which / whichever                       | choices + what   |
|       | kome         | everyone                                | all + person     |
|       | kogoko       | everything                              | all + thing      |
|       | kogogun      | everywhere                              | all + land       |
|       | koyuntsu     | always / every time                     | all + time       |
|       | ksome        | noone                                   | no + person      |
|       | ksogoko      | nothing                                 | no + thing       |
|       | ksogogun     | nowhere                                 | no + land        |
|       | ksoyuntsu    | never                                   | no + time        |
|       | ksoetse      | none / neither                          | no + choices     |
|       | meshietse    | others                                  | who + other      |
### Metalanguage
...
|       | ja-en'tse     | verb                                | word + (vrb) + (<-semantic)     |
|       | ja-an'tse     | adjective                           | word + (adj) + (<-semantic)     |
|       | jagoko        | noun / name                         | word + thing                    |
...
|       | medo       | he / him    | person + male           |
|       | mebu       | she / her   | person + female         |
|       | memeon     | they / them | person + person + (far) |
|       | gokoin     | this        | thing + (near)          |
|       | gokoon     | that / it   | thing + (far)           |
|       | gokoin'tso | these       | this + (plural)         |
|       | gokoon'tso | those       | that + (plural)         |
|       |            |             |                         |
### Grammar

| glyph                    | sound                      | meaning                                                             | combo                                 |
| ------------------------ | -------------------------- | ------------------------------------------------------------------- | ------------------------------------- |
|                          | etseko                     | any                                                                 | other/choices + all                   |
|                          | otseun                     | in addition / also                                                  | addition + (context)                  |
|                          | otsenen'un                 | again / another time / once more                                    | repetition + (context)                |
|                          | dun'zhin'un                | can ... / could ... / may ... / might ... (in terms of possibility) | possibility (minus "tse") + (context) |
|                          | toun                       | able to ... / can ... (in terms of ability)                         | ability + (context)                   |
|                          | in'yuntsu-piun ... un, ... | while (clause), ...                                                 | during + of + (context)               |
|                          | yuntsu-piun ... un, ....   | when (clause), ...                                                  | time + of + (context)                 |
|                          | pidha                      | (relative clause) / that / which / who                              | of + (subj)                           |
|                          | un'dha                     | (turns the preceding clause into the subject) / ...ing ... is       | (context) + (subj)                    |
|                          | ()eksoun                   | Whether or not ...                                                  | or + not + (context)                  |
|                          | ()eksoun'dha               | Whether or not ... is                                               | or + not + (context) + (subj)         |
...
|                          | -thime(...)-goko           | (noun form of any person causative verb)                            | because + (any person) + thing        |
...
|                          | -en'goko                   | (verbal noun form)                                                  | verb + thing                          |
|                          | -thiho                     | from / than                                                         | because + direction                   |
|                          | -thaho                     | to / for                                                            | therefore + direction                 |
...
|                          | oun'kso                    | without (someone/something)                                         | with + not                            |
|                          | -in'teun                   | using                                                               | in + hand + (context)                 |
