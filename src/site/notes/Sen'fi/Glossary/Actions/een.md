...
| infl. | class  | meaning                                         |
| ----- | ------ | ----------------------------------------------- |
| ~     | *n.*   | action, activity, act                           |
| ~en   | *v.*   | to do, carry out, perform (tr.), to act (intr.) |
| ~a    | *psv.* | done, carried out, performed                    |
| ~an   | *adj.* | active                                          |
| ~un   | *adv.* | actively                                        |
### Grammar counterpart
*See [[Sen'fi/Glossary/Grammar/en\|en]] for the original use and etymology.*